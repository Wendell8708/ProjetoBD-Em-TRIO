...
ORDER BY
    ...
    -- 20 --  Quais são os exemplares
--  (número de série e título do livro) que estão fisicamente localizados na 'Estante A1' (Localização ID 1)
